...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center px-6 py-20">
      <div className="container-fluid lg:grid lg:grid-cols-2 lg:items-center lg:gap-20">
        <div>
          ...
          <p
            ...
            className="reveal text-fluid-body mt-6 max-w-md text-balance leading-relaxed text-muted lg:max-w-none"
          >
          ...
          <div className="mt-14 flex flex-col gap-4 sm:flex-row sm:items-center">
            ...
            <a
              ...
              data-mounted={mounted}
              style={{ animationDelay: "300ms" }}
              className="reveal inline-flex items-center justify-center px-2 py-3.5 text-sm font-medium text-muted transition-colors hover:text-foreground focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent lg:hidden"
            >
              How it works
            </a>
          </div>
        ...
        <div id="how-it-works" className="mt-28 scroll-mt-10 lg:mt-0">
            ...
            {PROOF_CHAIN.map((step, i) => (
              ...
              >
                <span
                  ...
                  aria-hidden="true"
                />
                <p className="font-mono text-xs uppercase tracking-[0.15em] text-accent md:text-sm">
                  {step.label}
                </p>
